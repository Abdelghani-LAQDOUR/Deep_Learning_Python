...
class Classifier {
  ...
  classifyDrawing(List points) async {
  ...
  Future<int> getPred(Uint8List imgAsList) async {
    ...
    final List<double> resultBytes = List.filled(mnistSize*mnistSize, 0.0, growable: true);
    ...
    var output = List.filled(1*10, null, growable: true).reshape([1, 10]);
    ...
    try {
      Interpreter interpreter = await Interpreter.fromAsset("model_Mnist.tflite",
